 ...
 */
   ...
   */
    gtsam::Values pose3WithZeroTranslation(const gtsam::Values& rotations);
      /**
       * @brief pose3WithOriginTranslation sets the translation part to the original value
       *
       */
    void pose3WithOriginTranslation(const gtsam::Values& rotations, gtsam::Values& initial);
