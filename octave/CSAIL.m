...
%% settings
ori_folder = horzcat(pwd, '/../test_data/datasets/CSAIL/CSAIL_P_toro.graph');
spilt_folder = horzcat(pwd, '/../test_data/datasets/CSAIL/spilt_100random/');
mkdir(spilt_folder);
number_of_robots = 2;
id_offset = 96;
...
%% spilt city10000
 [ robot_poses, robot_measurements, robot_edges_id, poses, measurements, edges_id, trajectory_size]...
     = covert2Dto3DTORO( ori_folder, robots_offsets );
